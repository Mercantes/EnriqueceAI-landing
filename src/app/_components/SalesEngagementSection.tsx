...
const funnelLayers = [
  { label: 'Automação de Marketing', description: 'Geração de demanda e nutrição de leads', highlight: false, width: 'w-full' },
  { label: 'Sales Engagement', description: 'Prospecção e qualificação através de cadências', highlight: true, width: 'w-[82%]' },
  { label: 'CRM', description: 'Reuniões de diagnóstico, demonstrações e negociações', highlight: false, width: 'w-[64%]' },
];
    ...
    <section className="py-24">
      <div className="mx-auto max-w-5xl px-6">
        <div className="mb-20 text-center">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">O que é Sales Engagement?</h2>
          ...
          <div className="mt-14 flex items-center justify-center gap-0 overflow-x-auto px-4">
            {timelineSteps.map((step, i) => (
              <div key={step.day} className="flex items-center">
                {i > 0 && <div className="h-0.5 w-8 bg-[var(--primary)] sm:w-12" />}
